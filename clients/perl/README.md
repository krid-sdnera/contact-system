...
use WWW::OpenAPIClient::Object::JwtRefreshInput;
...
*ContactsApi* | [**create_contact**](docs/ContactsApi.md#create_contact) | **POST** /contacts | 
*ContactsApi* | [**delete_contact_by_id**](docs/ContactsApi.md#delete_contact_by_id) | **DELETE** /contacts/{contactId} | 
*ContactsApi* | [**get_contact_by_id**](docs/ContactsApi.md#get_contact_by_id) | **GET** /contacts/{contactId} | Your GET endpoint
*ContactsApi* | [**get_contacts**](docs/ContactsApi.md#get_contacts) | **GET** /contacts | Your GET endpoint
*ContactsApi* | [**patch_contact_by_id**](docs/ContactsApi.md#patch_contact_by_id) | **PATCH** /contacts/{contactId} | 
*ContactsApi* | [**update_contact_by_id**](docs/ContactsApi.md#update_contact_by_id) | **PUT** /contacts/{contactId} | 
*ListsApi* | [**create_list**](docs/ListsApi.md#create_list) | **POST** /lists | 
*ListsApi* | [**create_list_rule_by_id**](docs/ListsApi.md#create_list_rule_by_id) | **POST** /lists/{listId}/rules | 
*ListsApi* | [**create_list_types**](docs/ListsApi.md#create_list_types) | **POST** /lists/types | 
*ListsApi* | [**delete_list_by_id**](docs/ListsApi.md#delete_list_by_id) | **DELETE** /lists/{listId} | 
*ListsApi* | [**delete_list_rule_by_id**](docs/ListsApi.md#delete_list_rule_by_id) | **DELETE** /lists/{listId}/rules/{ruleId} | 
*ListsApi* | [**delete_list_type_by_id**](docs/ListsApi.md#delete_list_type_by_id) | **DELETE** /lists/types/{listTypeId} | 
*ListsApi* | [**get_list_by_id**](docs/ListsApi.md#get_list_by_id) | **GET** /lists/{listId} | Your GET endpoint
*ListsApi* | [**get_list_members_by_id**](docs/ListsApi.md#get_list_members_by_id) | **GET** /lists/{listId}/members | Your GET endpoint
*ListsApi* | [**get_list_rule_by_id**](docs/ListsApi.md#get_list_rule_by_id) | **GET** /lists/{listId}/rules/{ruleId} | Your GET endpoint
*ListsApi* | [**get_list_rules_by_id**](docs/ListsApi.md#get_list_rules_by_id) | **GET** /lists/{listId}/rules | Your GET endpoint
*ListsApi* | [**get_list_type_by_id**](docs/ListsApi.md#get_list_type_by_id) | **GET** /lists/types/{listTypeId} | Your GET endpoint
*ListsApi* | [**get_list_types**](docs/ListsApi.md#get_list_types) | **GET** /lists/types | Your GET endpoint
*ListsApi* | [**get_lists**](docs/ListsApi.md#get_lists) | **GET** /lists | Your GET endpoint
*ListsApi* | [**update_list_by_id**](docs/ListsApi.md#update_list_by_id) | **PUT** /lists/{listId} | 
*ListsApi* | [**update_list_rule_by_id**](docs/ListsApi.md#update_list_rule_by_id) | **PUT** /lists/{listId}/rules/{ruleId} | 
*ListsApi* | [**update_list_type_by_id**](docs/ListsApi.md#update_list_type_by_id) | **PUT** /lists/types/{listTypeId} | 
...
*MembersApi* | [**patch_member_by_id**](docs/MembersApi.md#patch_member_by_id) | **PATCH** /members/{memberId} | Partially update member
...
*ScoutGroupsApi* | [**get_scout_group_sections_by_id**](docs/ScoutGroupsApi.md#get_scout_group_sections_by_id) | **GET** /groups/{scoutGroupId}/sections | Your GET endpoint
...
*SectionsApi* | [**get_section_roles_by_id**](docs/SectionsApi.md#get_section_roles_by_id) | **GET** /sections/{sectionId}/roles | Your GET endpoint
...
# DOCUMENTATION FOR MODELS
 ...
 - [WWW::OpenAPIClient::Object::JwtRefreshInput](docs/JwtRefreshInput.md)
 - [WWW::OpenAPIClient::Object::List](docs/List.md)
 - [WWW::OpenAPIClient::Object::ListRule](docs/ListRule.md)
 - [WWW::OpenAPIClient::Object::ListType](docs/ListType.md)
