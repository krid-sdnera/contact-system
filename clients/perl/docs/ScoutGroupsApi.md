...
[**get_scout_group_sections_by_id**](ScoutGroupsApi.md#get_scout_group_sections_by_id) | **GET** /groups/{scoutGroupId}/sections | Your GET endpoint
...
# **get_scout_group_sections_by_id**
> Sections get_scout_group_sections_by_id(scout_group_id => $scout_group_id)
...
eval { 
    my $result = $api_instance->get_scout_group_sections_by_id(scout_group_id => $scout_group_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling ScoutGroupsApi->get_scout_group_sections_by_id: $@\n";
}
```
