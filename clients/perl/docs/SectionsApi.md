...
[**get_section_roles_by_id**](SectionsApi.md#get_section_roles_by_id) | **GET** /sections/{sectionId}/roles | Your GET endpoint
...
# **get_section_roles_by_id**
> Roles get_section_roles_by_id(section_id => $section_id)
...
eval { 
    my $result = $api_instance->get_section_roles_by_id(section_id => $section_id);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling SectionsApi->get_section_roles_by_id: $@\n";
}
```
