 ...
 */
final class Version20201130092456 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__role AS SELECT id, section_id, name, class_id, normalised_class_id, external_id FROM role');
        $this->addSql('DROP TABLE role');
        $this->addSql('CREATE TABLE role (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, section_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, class_id VARCHAR(255) NOT NULL COLLATE BINARY, normalised_class_id VARCHAR(255) NOT NULL COLLATE BINARY, external_id VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_57698A6AD823E37A FOREIGN KEY (section_id) REFERENCES section (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO role (id, section_id, name, class_id, normalised_class_id, external_id) SELECT id, section_id, name, class_id, normalised_class_id, external_id FROM __temp__role');
        ...
        , phone_home VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone_mobile VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone_work VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, occupation VARCHAR(255) DEFAULT NULL COLLATE BINARY, relationship VARCHAR(255) DEFAULT NULL COLLATE BINARY, primary_contact BOOLEAN NOT NULL, state VARCHAR(255) DEFAULT \'enabled\' NOT NULL COLLATE BINARY, management_state VARCHAR(255) DEFAULT \'unmanaged\' NOT NULL COLLATE BINARY, expiry DATE DEFAULT NULL, parent_id INTEGER DEFAULT NULL, overrides CLOB NOT NULL --(DC2Type:json)
        , CONSTRAINT FK_4C62E6387597D3FE FOREIGN KEY (member_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, membership_number, firstname, lastname, nickname, date_of_birth, gender, address, phone_home, phone_mobile, phone_work, email, state, management_state, expiry, overrides, school_name, school_year_level FROM member');
        ...
        , phone_home VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone_mobile VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone_work VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, state VARCHAR(255) DEFAULT \'enabled\' NOT NULL COLLATE BINARY, management_state VARCHAR(255) DEFAULT \'unmanaged\' NOT NULL COLLATE BINARY, expiry DATE DEFAULT NULL, school_name VARCHAR(255) DEFAULT NULL COLLATE BINARY, school_year_level VARCHAR(255) DEFAULT NULL COLLATE BINARY, overrides CLOB NOT NULL --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO member (id, membership_number, firstname, lastname, nickname, date_of_birth, gender, address, phone_home, phone_mobile, phone_work, email, state, management_state, expiry, overrides, school_name, school_year_level) SELECT id, membership_number, firstname, lastname, nickname, date_of_birth, gender, address, phone_home, phone_mobile, phone_work, email, state, management_state, expiry, overrides, school_name, school_year_level FROM __temp__member');
        $this->addSql('DROP TABLE __temp__member');
        $this->addSql('DROP INDEX IDX_2D737AEFE800F96A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__section AS SELECT id, scout_group_id, name, external_id FROM section');
        $this->addSql('DROP TABLE section');
        $this->addSql('CREATE TABLE section (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, scout_group_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, external_id VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_2D737AEFE800F96A FOREIGN KEY (scout_group_id) REFERENCES scout_group (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO section (id, scout_group_id, name, external_id) SELECT id, scout_group_id, name, external_id FROM __temp__section');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE __temp__contact');
        $this->addSql('CREATE INDEX IDX_4C62E6387597D3FE ON contact (member_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, membership_number, firstname, lastname, nickname, date_of_birth, gender, address, phone_home, phone_mobile, phone_work, email, school_name, school_year_level, state, management_state, expiry, overrides FROM member');
        $this->addSql('DROP TABLE member');
        ...
        , phone_home VARCHAR(255) DEFAULT NULL, phone_mobile VARCHAR(255) DEFAULT NULL, phone_work VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, school_name VARCHAR(255) DEFAULT NULL, school_year_level VARCHAR(255) DEFAULT NULL, state VARCHAR(255) DEFAULT \'enabled\' NOT NULL, management_state VARCHAR(255) DEFAULT \'unmanaged\' NOT NULL, expiry DATE DEFAULT NULL, overrides CLOB DEFAULT \'{}\' NOT NULL COLLATE BINARY --(DC2Type:json)
        )');
        $this->addSql('INSERT INTO member (id, membership_number, firstname, lastname, nickname, date_of_birth, gender, address, phone_home, phone_mobile, phone_work, email, school_name, school_year_level, state, management_state, expiry, overrides) SELECT id, membership_number, firstname, lastname, nickname, date_of_birth, gender, address, phone_home, phone_mobile, phone_work, email, school_name, school_year_level, state, management_state, expiry, overrides FROM __temp__member');
        $this->addSql('DROP TABLE __temp__member');
        $this->addSql('DROP INDEX IDX_ABE1A6367597D3FE');
        $this->addSql('DROP INDEX IDX_ABE1A636D60322AC');
        $this->addSql('CREATE TEMPORARY TABLE __temp__member_role AS SELECT member_id, role_id, state, management_state, expiry FROM member_role');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__role AS SELECT id, section_id, name, class_id, normalised_class_id, external_id FROM role');
        $this->addSql('DROP TABLE role');
        $this->addSql('CREATE TABLE role (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, section_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, class_id VARCHAR(255) NOT NULL, normalised_class_id VARCHAR(255) NOT NULL, external_id VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO role (id, section_id, name, class_id, normalised_class_id, external_id) SELECT id, section_id, name, class_id, normalised_class_id, external_id FROM __temp__role');
        $this->addSql('DROP TABLE __temp__role');
        $this->addSql('CREATE INDEX IDX_57698A6AD823E37A ON role (section_id)');
        $this->addSql('DROP INDEX IDX_2D737AEFE800F96A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__section AS SELECT id, scout_group_id, name, external_id FROM section');
        $this->addSql('DROP TABLE section');
        $this->addSql('CREATE TABLE section (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, scout_group_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, external_id VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO section (id, scout_group_id, name, external_id) SELECT id, scout_group_id, name, external_id FROM __temp__section');
        $this->addSql('DROP TABLE __temp__section');
        $this->addSql('CREATE INDEX IDX_2D737AEFE800F96A ON section (scout_group_id)');
    }
