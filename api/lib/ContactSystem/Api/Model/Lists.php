...
/**
 * Class representing the Lists model.
 *
 * A list of lists
 *
 * @package OpenAPI\Server\Model
...
class Lists 
{
     ...
     * })
     * @Type("array<OpenAPI\Server\Model\ListData>")
     */
    protected $lists;
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->lists = isset($data['lists']) ? $data['lists'] : null;
    }
     ...
     * Sets lists.
     *
     * @param OpenAPI\Server\Model\ListData[] $lists  Array containg the list
     *
     * @return $this
     */
