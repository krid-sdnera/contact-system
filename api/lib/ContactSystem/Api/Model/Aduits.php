...
/**
 * Class representing the Audits model.
 *
 * A list of audits
 *
 * @package OpenAPI\Server\Model
...
class Audits
{
     ...
     *
     * @var OpenAPI\Server\Model\AuditData[]
     * @SerializedName("audits")
     * @Assert\NotNull()
     * @Assert\Valid()
     * @Assert\All({
     *   @Assert\Type("OpenAPI\Server\Model\AuditData")
     * })
     * @Type("array<OpenAPI\Server\Model\AuditData>")
     */
    protected $audits;
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->audits = isset($data['audits']) ? $data['audits'] : null;
    }
     ...
     * Gets audits.
     *
     * @return OpenAPI\Server\Model\AuditData[]
     */
     ...
     * Sets audits.
     *
     * @param OpenAPI\Server\Model\AuditData[] $audits  Array containg the list
     *
     * @return $this
     */
