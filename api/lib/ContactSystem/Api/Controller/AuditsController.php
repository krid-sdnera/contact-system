...
/**
 * AuditsController Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Server\Controller
 * @author   OpenAPI Generator team
...
class AuditsController extends Controller
{
     ...
     */
    public function getAuditsAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->getAudits($query, $sort, $pageSize, $page, $responseCode, $responseHeaders);
     ...
     * @return AuditsApiInterface
     */
    public function getApiHandler()
    {
        return $this->apiServer->getApiHandler('audits');
    }
}
