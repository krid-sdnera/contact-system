...
class MembersController extends Controller
{
     ...
     * @return Response The Symfony response.
     */
    public function getListRulesByMemberIdAction(Request $request, $memberId)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
     ...
     * @return Response The Symfony response.
     */
    public function getMemberMergeSuggestionsAction(Request $request)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->getMemberMergeSuggestions($query, $sort, $pageSize, $page, $responseCode, $responseHeaders);
