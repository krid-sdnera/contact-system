...
class GroupsController extends Controller
{
     ...
     */
    public function deleteGroupsGroupIdLocalAction(Request $request, $groupId)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->deleteGroupsGroupIdLocal($groupId, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function getGroupsGroupIdMembersAction(Request $request, $groupId)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->getGroupsGroupIdMembers($groupId, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function getGroupsGroupIdSectionsAction(Request $request, $groupId)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->getGroupsGroupIdSections($groupId, $responseCode, $responseHeaders);
    ...
    public function postGroupsAction(Request $request)
    {
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->postGroups($group, $responseCode, $responseHeaders);
     ...
     * @return Response The Symfony response.
     */
    public function putGroupsGroupIdLocalAction(Request $request, $groupId)
    {
        // Figure out what data format to return to the client
        $produces = ['application/json'];
        // Figure out what the client accepts
        ...
        try {
            ...
            $responseCode = 200;
            $responseHeaders = [];
            $result = $handler->putGroupsGroupIdLocal($groupId, $responseCode, $responseHeaders);
