 ...
 */
final class Version20200531125517 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE member ADD COLUMN state VARCHAR(255) DEFAULT \'enabled\' NOT NULL');
        $this->addSql('ALTER TABLE member ADD COLUMN management_state VARCHAR(255) DEFAULT \'unmanaged\' NOT NULL');
        $this->addSql('ALTER TABLE member ADD COLUMN expiry DATE DEFAULT NULL');
        $this->addSql('ALTER TABLE member ADD COLUMN overrides CLOB DEFAULT \'{}\' NOT NULL');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__contact AS SELECT id, member_id, firstname, nickname, lastname, address, phone_home, phone_mobile, phone_work, email, occupation, relationship, primary_contact FROM contact');
        ...
        , phone_home VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone_mobile VARCHAR(255) DEFAULT NULL COLLATE BINARY, phone_work VARCHAR(255) DEFAULT NULL COLLATE BINARY, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, occupation VARCHAR(255) DEFAULT NULL COLLATE BINARY, relationship VARCHAR(255) DEFAULT NULL COLLATE BINARY, primary_contact BOOLEAN NOT NULL, state VARCHAR(255) DEFAULT \'enabled\' NOT NULL, management_state VARCHAR(255) DEFAULT \'unmanaged\' NOT NULL, expiry DATE DEFAULT NULL, overrides CLOB DEFAULT \'{}\' NOT NULL --(DC2Type:json)
        , CONSTRAINT FK_4C62E6387597D3FE FOREIGN KEY (member_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO contact (id, member_id, firstname, nickname, lastname, address, phone_home, phone_mobile, phone_work, email, occupation, relationship, primary_contact) SELECT id, member_id, firstname, nickname, lastname, address, phone_home, phone_mobile, phone_work, email, occupation, relationship, primary_contact FROM __temp__contact');
        ...
        $this->addSql('CREATE TABLE member_role (member_id INTEGER NOT NULL, role_id INTEGER NOT NULL, state VARCHAR(255) DEFAULT \'enabled\' NOT NULL, management_state VARCHAR(255) DEFAULT \'unmanaged\' NOT NULL, expiry DATE DEFAULT NULL, PRIMARY KEY(member_id, role_id), CONSTRAINT FK_ABE1A6367597D3FE FOREIGN KEY (member_id) REFERENCES member (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_ABE1A636D60322AC FOREIGN KEY (role_id) REFERENCES role (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , phone_home VARCHAR(255) DEFAULT NULL, phone_mobile VARCHAR(255) DEFAULT NULL, phone_work VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, occupation VARCHAR(255) DEFAULT NULL, relationship VARCHAR(255) DEFAULT NULL, primary_contact BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO contact (id, member_id, firstname, nickname, lastname, address, phone_home, phone_mobile, phone_work, email, occupation, relationship, primary_contact) SELECT id, member_id, firstname, nickname, lastname, address, phone_home, phone_mobile, phone_work, email, occupation, relationship, primary_contact FROM __temp__contact');
        $this->addSql('DROP TABLE __temp__contact');
        $this->addSql('CREATE INDEX IDX_4C62E6387597D3FE ON contact (member_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__member AS SELECT id, firstname, lastname, nickname, address, date_of_birth, membership_number, phone_home, phone_mobile, phone_work, gender, email FROM member');
        ...
        , date_of_birth DATE DEFAULT NULL, membership_number VARCHAR(255) DEFAULT NULL, phone_home VARCHAR(255) DEFAULT NULL, phone_mobile VARCHAR(255) DEFAULT NULL, phone_work VARCHAR(255) DEFAULT NULL, gender VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO member (id, firstname, lastname, nickname, address, date_of_birth, membership_number, phone_home, phone_mobile, phone_work, gender, email) SELECT id, firstname, lastname, nickname, address, date_of_birth, membership_number, phone_home, phone_mobile, phone_work, gender, email FROM __temp__member');
