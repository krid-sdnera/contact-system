...
sed -i -e 's/"symfony\/framework-bundle": "^4.4.8"/"symfony\/framework-bundle": "^4.4.8|^5.0"/' api/lib/ContactSystem/Api/composer.json
...
sed -i -e 's/return this.configuration.fetchApi;/return this.configuration.fetchApi!;/' ui/lib/ContactSystem/Client/src/runtime.ts
